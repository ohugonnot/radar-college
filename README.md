...
Plateforme d'évaluations diagnostiques pour collégiens : **16 quiz** (6ème → 3ème × maths / physique-chimie / SVT / histoire), rapport détaillé par chapitre, plan de révision ciblé, PWA installable.
...
| Build         | `build.sh` (bash + python) : inline CSS + app.tsx + 16 quizzes .tsx            |
